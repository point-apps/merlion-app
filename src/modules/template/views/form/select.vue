  ...
  <div class="main-content-container">
    ...
    <div class="card space-y-5 p-4">
      ...
      <label class="block">
        ...
        <select
          class="form-select focus:border-primary dark:focus:border-accent mt-1.5 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 hover:border-slate-400 dark:border-slate-500 dark:bg-slate-700 dark:hover:border-slate-400"
        >
      ...
      <div class="flex flex-col">
        <popper placement="bottom-start">
          ...
          <template #content="contentProps">
            <div
              class="mx-4 mt-1 flex max-h-[calc(100vh-6rem)] w-[calc(100vw-2rem)] flex-col rounded-lg border-slate-100 bg-white dark:border-slate-800 dark:bg-slate-700 sm:m-0 sm:w-80"
            >
              <ul class="my-2">
                <li>
                  <button
                  ...
                  >
                    <div>
                      <p class="text-slate-700 line-clamp-1 dark:text-slate-100">Simon Tods</p>
                      <p class="text-xs text-slate-500 dark:text-slate-300">Web Developer</p>
                    </div>
                  </button>
                </li>
                <li>
