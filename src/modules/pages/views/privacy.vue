    ...
    <div class="card space-y-5 p-10">
      ...
      <div>
        ...
        <table>
          <tbody>
            <tr>
              <td class="align-top font-bold">Account</td>
              <td class="px-4">
                means a unique account created for You to access our Service or parts of our Service.
              </td>
            </tr>
            <tr>
              <td class="align-top font-bold">Company</td>
              <td class="px-4">
            ...
            <tr>
              <td class="align-top font-bold">Cookies</td>
              <td class="px-4">
            ...
            <tr>
              <td class="align-top font-bold">Device</td>
              <td class="px-4">
                means any device that can access the Service such as a computer, a cellphone or a digital tablet.
              </td>
            </tr>
            <tr>
              <td class="align-top font-bold">Personal Data</td>
              <td class="px-4">is any information that relates to an identified or identifiable individual.</td>
            </tr>
            <tr>
              <td class="align-top font-bold">Service</td>
              <td class="px-4">refers to the Website.</td>
            </tr>
            <tr>
              <td class="align-top font-bold">Third-party Social Media Service</td>
              <td class="px-4">
            ...
            <tr>
              <td class="align-top font-bold">Usage data</td>
              <td class="px-4">
            ...
            <tr>
              <td class="align-top font-bold">Website</td>
              <td class="px-4">
            ...
            <tr>
              <td class="align-top font-bold">You</td>
              <td class="px-4">
